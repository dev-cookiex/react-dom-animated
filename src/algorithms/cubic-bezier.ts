...
const binarySubdivide = ( aX: number, _aA: number, _aB: number, mX1: number, mX2: number ) => {
  let currentX: number, currentT: number, i = 0, aA = _aA, aB = _aB
  do {
...
const newtonRaphsonIterate = ( aX: number, _aGuessT: number, mX1: number, mX2: number ) => {
...
const bezier = ( mX1: number, mY1: number, mX2: number, mY2: number ) => {
